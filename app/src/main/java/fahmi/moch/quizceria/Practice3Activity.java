...
public class Practice3Activity extends AppCompatActivity {
    ...
    Practice3Activity.SoalPilihanGanda soalPG = new Practice3Activity.SoalPilihanGanda();
    ...
    private void setKonten() {
        ...
        if (x >= arr) { //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(Practice3Activity.this, ScoreActivity.class);
    ...
    public class SoalPilihanGanda {
        ...
        private String pilihanJawaban[][] = {
                ...
                {"Malaysia", "Amerika Serikat", "Chile"},
                {"Kolombia", "Chile", "Paraguay"},
                {"Kolombia", "Monaco", "Singapura"},
                {"Bolivia", "Kolombia", "Ghana"},
                {"Argentina", "Kuba", "Brazil"},
                {"Italia", "Meksiko", "Brazil"},
                {"Mexico", "Argentina", "Uruguay"},
                {"Kanada", "Amerika Serikat", "Argentina"}
        };
